    ...
    return (
      ...
      >
        ...
        <div className="absolute inset-x-0 bottom-0 p-4 md:static md:p-6 md:flex md:flex-col md:justify-between md:bg-transparent">
          <div>
            <h2 className="text-lg font-semibold text-white md:text-[#4B3429] mb-2 leading-snug">{title}</h2>
            <p className="text-sm text-white/90 md:text-[#5D4B41] leading-relaxed hidden md:block">{summary}</p>
          </div>
